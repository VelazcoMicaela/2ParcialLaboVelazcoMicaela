...
/** \brief Filtra y crea una lista de los elementos de la lista utilizando la funcion criterio recibida como parametro
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return LinkedList* Retorna  (NULL) Error: si el puntero a la listas es NULL
                                (puntero a la nueva lista) Si ok
...
/** \brief  itera todos los elementos
de la lista y se los pasa a la función “pFunc” que recibirá el elemento y le asignará a los campos un número aleatorio y calculará el campo sinVacunar. el retorno de
“pFunc” que es el país con todos sus campos cargados se agregará a la lista resultado
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return LinkedList* Retorna  (NULL) Error: si el puntero a la listas es NULL
                                (puntero a la nueva lista) Si ok
...
LinkedList* ll_map (LinkedList* this, int(*pFunc)(void*))
{
	...
	if(this!=NULL && pFunc!=NULL && listaResultado!=NULL)
	{
		tam=ll_len(this);
